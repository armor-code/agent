...
def main() -> None:
    ...
    logger.info("Agent Started for url %s, verify %s, timeout %s, read_timeout_seconds %s, outgoing proxy %s, inward %s, uploadToAc %s",
                config_dict.get('server_url'),
                config_dict.get('verify_cert', False), config_dict.get('timeout', 10),
                config_dict.get('read_timeout_seconds', 100),
